...
def run_test_largest_number():
    ...
    # Test 4:
    expected = 2
    answer = largest_number(([2], [1], [0]))
    print('Expected and actual are:', expected, answer)

    # Test 5:
    expected = 44444
    answer = largest_number(([34], [44444], [1]))
    print('Expected and actual are:', expected, answer)
...
def run_test_largest_negative_number():
    ...
    # Test 4:
    expected = None
    answer = largest_negative_number(([2], [1], [0]))
    print('Expected and actual are:', expected, answer)

    # Test 5:
    expected = -44444
    answer = largest_negative_number(([34], [-44444], [1]))
    print('Expected and actual are:', expected, answer)
